...
from stable_baselines3 import PPO_REWARD_EXPLORE
...
if __name__ == "__main__":
    ...
    parser.add_argument("-tb", "--tensorboard-log", help="Tensorboard log dir", default="logs/PrefPPO-explore/", type=str)
    ...
    # exploration
    parser.add_argument("--beta-init", help="initial weight of exploration bonus", type=float, default=0.01)
    parser.add_argument("--beta-decay", help="decay rate in weight of exploration bonus", type=float, default=0.0001)
    parser.add_argument("--beta-schedule", help="schedule of exploration bonus", type=str, default="constant") # "constant" or "linear_decay"
    # logistics
    parser.add_argument("--date", help="date of experiment", type=str, default='2021-12-31')
    ...
    args.tensorboard_log += '/' + args.date
    
    args.tensorboard_log += '/beta_init' + str(args.beta_init)
    args.tensorboard_log += '_decay' + str(args.beta_decay)
    args.tensorboard_log += '_schedule_' + args.beta_schedule
